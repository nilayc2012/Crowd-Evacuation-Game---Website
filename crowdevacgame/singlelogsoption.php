...
<select name="scene" form="form1">
  <option value="Level1SinglePlayer">Level1</option>
  <option value="Level2SinglePlayer">Level2</option>
  <option value="Level3SinglePlayer">Level3</option>
  <option value="Level4SinglePlayer">Level4</option>
<option value="Level5SinglePlayer">Level5</option>
</select>
...
<form action="http://spanky.rutgers.edu/crowdevacgame/singlelogs.php" method="post" id="form1">
